...
HEURISTIC_COMPATIBLE_MAPPING_TABLE = {
    ...
    # from 2024 reformatted column names
    ...
    # from 2025 reformatted column names
    "Where are you from? / 來自國家、地區或縣市": "country_or_region",
    "(Attend first time) How did you know PyCon TW 2025? / (初次參與) 如何得知 PyCon TW 2025？": "how_did_you_know_pycon_tw",
}
